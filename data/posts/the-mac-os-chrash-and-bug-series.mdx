...
status: publish
disqusId: /2011/08/27/the-mac-os-chrash-and-bug-series
jekyllPath: /2011-08-27-the-mac-os-chrash-and-bug-series
---
...
`bashkernel[0]: nstat_lookup_entry failed: 2`
...
````bashAug 7 22:57:20 kernel[0]: WaitForStamp: Overflowed waiting for stamp 0x0 on Main ring: called from
...
Aug 7 22:57:20 kernel[0]: kINSTDONE_1: 0xffffffff```
