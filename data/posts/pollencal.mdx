...
slug: pollencal
subtitle: >-
  Integrating hyperlocal pollen forecasts into your existing daily schedules. A
  web-calendar subscription with detailed and reliable pollen indexes of over 14
  species, without having to check a separate app.
summary: >-
  Integrating hyperlocal pollen forecasts into your existing daily schedules. A
  web-calendar subscription with detailed and reliable pollen indexes of over 14
  species, without having to check a separate app.
...
comments: true
published: true
disqusId: /2024/05/17/pollencal
jekyllPath: /2024-05-17-pollencal
---
...
<div class="flex place-content-center xl:float-right xl:ml-10">
  ![Grafana Dashboard of the powerfox exporter](/static/images/2024-05-17-pollencal.png)
</div>
