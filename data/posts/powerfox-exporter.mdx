...
subtitle: >-
  Introducing an exporter for the Powerfox energy data to track and visualize
  your consumptions in real-time.
summary: >-
  Introducing an exporter for the Powerfox energy data to track and visualize
  your consumptions in real-time.
date: '2024-02-07'
...
comments: true
published: true
disqusId: /2024/02/07/powerfox-exporter
jekyllPath: /2024-02-07-powerfox-exporter
---

![Grafana Dashboard of the powerfox exporter](/static/images/2024-02-07-powerfox-exporter.png)
