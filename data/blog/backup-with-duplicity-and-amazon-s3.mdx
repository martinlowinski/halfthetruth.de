...
There is lots of <a href="http://www.wolke.hs-furtwangen.de/">research</a> going on at my <a href="http://www.hs-furtwangen.de">university</a> on cloud computing and some friends from uni even wrote their final thesis on that kind of topic.
...
Next step is the configuration of the two. To create the folder-structure and the configuration files for
duply, simply run:
...
you, the FAQ of GnuPG describes another way to use your <a href="http://www.gnupg.org/faq/GnuPG-FAQ.html#how-can-i-use-gnupg-in-an-automated-environment">gpg-key in an automated environment</a>. Line 3 specifies that we want to use Amazons S3 service over HTTPS (despites the url says http).
You get your username and password from your <a href="http://aws.amazon.com/account/">AWS account</a> known as the Access Key ID and the Secret Access Key. The bucket-name is an unique identifier
